...
We can take the outputs pf the blog_scraper and analyse the text. There are 3 really useful R packages for this `tm`, `tidytext` and `quanteda`.

```{r, message=FALSE}
library(quanteda)

blog_corp <- corpus(blog)
