...
```{r warning=FALSE}
blogs <- blog_df_cat(category = "health-matters", n = 4)
...
url <- paste0("https://publichealthmatters.blog.gov.uk/category/", "priority5", "/")
url1 <- paste0("https://publichealthmatters.blog.gov.uk/category/", "priority5", "/page/", 1:1, "/")
# 
...
# 
# 
 blog_df_test <- bind_rows(blog_df_test, blogs_test) %>% distinct()
# 
# 
 }
# 
